...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_KARATECHOP   - 1] = gMoveDescription_KarateChop,
    [MOVE_DOUBLESLAP   - 1] = gMoveDescription_DoubleSlap,
    [MOVE_COMETPUNCH   - 1] = gMoveDescription_CometPunch,
    [MOVE_MEGAPUNCH    - 1] = gMoveDescription_MegaPunch,
    [MOVE_PAYDAY       - 1] = gMoveDescription_PayDay,
    [MOVE_FIREPUNCH    - 1] = gMoveDescription_FirePunch,
    [MOVE_ICEPUNCH     - 1] = gMoveDescription_IcePunch,
    [MOVE_THUNDERPUNCH - 1] = gMoveDescription_ThunderPunch,
    [MOVE_SCRATCH       - 1] = gMoveDescription_Scratch,
    [MOVE_VICEGRIP     - 1] = gMoveDescription_ViceGrip,
    [MOVE_GUILLOTINE    - 1] = gMoveDescription_Guillotine,
    [MOVE_RAZORWIND    - 1] = gMoveDescription_RazorWind,
    [MOVE_SWORDSDANCE  - 1] = gMoveDescription_SwordsDance,
    [MOVE_CUT           - 1] = gMoveDescription_Cut,
    [MOVE_GUST          - 1] = gMoveDescription_Gust,
    [MOVE_WINGATTACK   - 1] = gMoveDescription_WingAttack,
    ...
    [MOVE_VINEWHIP     - 1] = gMoveDescription_VineWhip,
    [MOVE_STOMP         - 1] = gMoveDescription_Stomp,
    [MOVE_DOUBLEKICK   - 1] = gMoveDescription_DoubleKick,
    [MOVE_MEGAKICK     - 1] = gMoveDescription_MegaKick,
    [MOVE_JUMPKICK     - 1] = gMoveDescription_JumpKick,
    [MOVE_ROLLINGKICK  - 1] = gMoveDescription_RollingKick,
    [MOVE_SANDATTACK   - 1] = gMoveDescription_SandAttack,
    [MOVE_HEADBUTT      - 1] = gMoveDescription_Headbutt,
    [MOVE_HORNATTACK   - 1] = gMoveDescription_HornAttack,
    [MOVE_FURYATTACK   - 1] = gMoveDescription_FuryAttack,
    [MOVE_HORNDRILL    - 1] = gMoveDescription_HornDrill,
    [MOVE_TACKLE        - 1] = gMoveDescription_Tackle,
    [MOVE_BODYSLAM     - 1] = gMoveDescription_BodySlam,
    [MOVE_WRAP          - 1] = gMoveDescription_Wrap,
    [MOVE_TAKEDOWN     - 1] = gMoveDescription_TakeDown,
    [MOVE_THRASH        - 1] = gMoveDescription_Thrash,
    [MOVE_DOUBLEEDGE   - 1] = gMoveDescription_DoubleEdge,
    [MOVE_TAILWHIP     - 1] = gMoveDescription_TailWhip,
    [MOVE_POISONSTING  - 1] = gMoveDescription_PoisonSting,
    [MOVE_TWINEEDLE     - 1] = gMoveDescription_Twineedle,
    [MOVE_PINMISSILE   - 1] = gMoveDescription_PinMissile,
    ...
    [MOVE_WATERGUN     - 1] = gMoveDescription_WaterGun,
    [MOVE_HYDROPUMP    - 1] = gMoveDescription_HydroPump,
    ...
    [MOVE_AURORABEAM   - 1] = gMoveDescription_AuroraBeam,
    [MOVE_HYPERBEAM    - 1] = gMoveDescription_HyperBeam,
    [MOVE_PECK          - 1] = gMoveDescription_Peck,
    [MOVE_DRILLPECK    - 1] = gMoveDescription_DrillPeck,
    [MOVE_SUBMISSION    - 1] = gMoveDescription_Submission,
    [MOVE_LOWKICK      - 1] = gMoveDescription_LowKick,
    [MOVE_COUNTER       - 1] = gMoveDescription_Counter,
    [MOVE_SEISMICTOSS  - 1] = gMoveDescription_SeismicToss,
    [MOVE_STRENGTH      - 1] = gMoveDescription_Strength,
    [MOVE_ABSORB        - 1] = gMoveDescription_Absorb,
    [MOVE_MEGADRAIN    - 1] = gMoveDescription_MegaDrain,
    [MOVE_LEECHSEED    - 1] = gMoveDescription_LeechSeed,
    [MOVE_GROWTH        - 1] = gMoveDescription_Growth,
    [MOVE_RAZORLEAF    - 1] = gMoveDescription_RazorLeaf,
    [MOVE_SOLARBEAM    - 1] = gMoveDescription_SolarBeam,
    [MOVE_POISONPOWDER - 1] = gMoveDescription_PoisonPowder,
    [MOVE_STUNSPORE    - 1] = gMoveDescription_StunSpore,
    [MOVE_SLEEPPOWDER  - 1] = gMoveDescription_SleepPowder,
    [MOVE_PETALDANCE   - 1] = gMoveDescription_PetalDance,
    [MOVE_STRINGSHOT   - 1] = gMoveDescription_StringShot,
    [MOVE_DRAGONRAGE   - 1] = gMoveDescription_DragonRage,
    [MOVE_FIRESPIN     - 1] = gMoveDescription_FireSpin,
    [MOVE_THUNDERSHOCK - 1] = gMoveDescription_ThunderShock,
    [MOVE_THUNDERBOLT   - 1] = gMoveDescription_Thunderbolt,
    [MOVE_THUNDERWAVE  - 1] = gMoveDescription_ThunderWave,
    [MOVE_THUNDER       - 1] = gMoveDescription_Thunder,
    [MOVE_ROCKTHROW    - 1] = gMoveDescription_RockThrow,
    ...
    [MOVE_CONFUSERAY   - 1] = gMoveDescription_ConfuseRay,
    [MOVE_WITHDRAW      - 1] = gMoveDescription_Withdraw,
    [MOVE_DEFENSECURL  - 1] = gMoveDescription_DefenseCurl,
    [MOVE_BARRIER       - 1] = gMoveDescription_Barrier,
    [MOVE_LIGHTSCREEN  - 1] = gMoveDescription_LightScreen,
    [MOVE_HAZE          - 1] = gMoveDescription_Haze,
    [MOVE_REFLECT       - 1] = gMoveDescription_Reflect,
    [MOVE_FOCUSENERGY  - 1] = gMoveDescription_FocusEnergy,
    [MOVE_BIDE          - 1] = gMoveDescription_Bide,
    [MOVE_METRONOME     - 1] = gMoveDescription_Metronome,
    [MOVE_MIRRORMOVE   - 1] = gMoveDescription_MirrorMove,
    [MOVE_SELFDESTRUCT - 1] = gMoveDescription_SelfDestruct,
    [MOVE_EGGBOMB      - 1] = gMoveDescription_EggBomb,
    [MOVE_LICK          - 1] = gMoveDescription_Lick,
    [MOVE_SMOG          - 1] = gMoveDescription_Smog,
    [MOVE_SLUDGE        - 1] = gMoveDescription_Sludge,
    [MOVE_BONECLUB     - 1] = gMoveDescription_BoneClub,
    [MOVE_FIREBLAST    - 1] = gMoveDescription_FireBlast,
    [MOVE_WATERFALL     - 1] = gMoveDescription_Waterfall,
    [MOVE_CLAMP         - 1] = gMoveDescription_Clamp,
    [MOVE_SWIFT         - 1] = gMoveDescription_Swift,
    [MOVE_SKULLBASH    - 1] = gMoveDescription_SkullBash,
    [MOVE_SPIKECANNON  - 1] = gMoveDescription_SpikeCannon,
    ...
    [MOVE_SOFTBOILED   - 1] = gMoveDescription_SoftBoiled,
    [MOVE_HIGHJUMPKICK  - 1] = gMoveDescription_HiJumpKick,
    [MOVE_GLARE         - 1] = gMoveDescription_Glare,
    [MOVE_DREAMEATER   - 1] = gMoveDescription_DreamEater,
    [MOVE_POISONGAS    - 1] = gMoveDescription_PoisonGas,
    [MOVE_BARRAGE       - 1] = gMoveDescription_Barrage,
    [MOVE_LEECHLIFE    - 1] = gMoveDescription_LeechLife,
    [MOVE_LOVELYKISS   - 1] = gMoveDescription_LovelyKiss,
    [MOVE_SKYATTACK    - 1] = gMoveDescription_SkyAttack,
    [MOVE_TRANSFORM     - 1] = gMoveDescription_Transform,
    [MOVE_BUBBLE        - 1] = gMoveDescription_Bubble,
    [MOVE_DIZZYPUNCH   - 1] = gMoveDescription_DizzyPunch,
    ...
    [MOVE_ACIDARMOR    - 1] = gMoveDescription_AcidArmor,
    [MOVE_CRABHAMMER    - 1] = gMoveDescription_Crabhammer,
    [MOVE_EXPLOSION     - 1] = gMoveDescription_Explosion,
    [MOVE_FURYSWIPES   - 1] = gMoveDescription_FurySwipes,
    [MOVE_BONEMERANG    - 1] = gMoveDescription_Bonemerang,
    [MOVE_REST          - 1] = gMoveDescription_Rest,
    [MOVE_ROCKSLIDE    - 1] = gMoveDescription_RockSlide,
    [MOVE_HYPERFANG    - 1] = gMoveDescription_HyperFang,
    [MOVE_SHARPEN       - 1] = gMoveDescription_Sharpen,
    [MOVE_CONVERSION    - 1] = gMoveDescription_Conversion,
    [MOVE_TRIATTACK    - 1] = gMoveDescription_TriAttack,
    [MOVE_SUPERFANG    - 1] = gMoveDescription_SuperFang,
    ...
    [MOVE_TRIPLEKICK   - 1] = gMoveDescription_TripleKick,
    [MOVE_THIEF         - 1] = gMoveDescription_Thief,
    [MOVE_SPIDERWEB    - 1] = gMoveDescription_SpiderWeb,
    [MOVE_MINDREADER   - 1] = gMoveDescription_MindReader,
    [MOVE_NIGHTMARE     - 1] = gMoveDescription_Nightmare,
    [MOVE_FLAMEWHEEL   - 1] = gMoveDescription_FlameWheel,
    [MOVE_SNORE         - 1] = gMoveDescription_Snore,
    [MOVE_CURSE         - 1] = gMoveDescription_Curse,
    [MOVE_FLAIL         - 1] = gMoveDescription_Flail,
    [MOVE_CONVERSION2  - 1] = gMoveDescription_Conversion2,
    [MOVE_AEROBLAST     - 1] = gMoveDescription_Aeroblast,
    [MOVE_COTTONSPORE  - 1] = gMoveDescription_CottonSpore,
    [MOVE_REVERSAL      - 1] = gMoveDescription_Reversal,
    [MOVE_SPITE         - 1] = gMoveDescription_Spite,
    [MOVE_POWDERSNOW   - 1] = gMoveDescription_PowderSnow,
    [MOVE_PROTECT       - 1] = gMoveDescription_Protect,
    [MOVE_MACHPUNCH    - 1] = gMoveDescription_MachPunch,
    [MOVE_SCARYFACE    - 1] = gMoveDescription_ScaryFace,
    [MOVE_FEINTATTACK  - 1] = gMoveDescription_FaintAttack,
    [MOVE_SWEETKISS    - 1] = gMoveDescription_SweetKiss,
    [MOVE_BELLYDRUM    - 1] = gMoveDescription_BellyDrum,
    [MOVE_SLUDGEBOMB   - 1] = gMoveDescription_SludgeBomb,
    [MOVE_MUDSLAP      - 1] = gMoveDescription_MudSlap,
    [MOVE_OCTAZOOKA     - 1] = gMoveDescription_Octazooka,
    [MOVE_SPIKES        - 1] = gMoveDescription_Spikes,
    [MOVE_ZAPCANNON    - 1] = gMoveDescription_ZapCannon,
    [MOVE_FORESIGHT     - 1] = gMoveDescription_Foresight,
    [MOVE_DESTINYBOND  - 1] = gMoveDescription_DestinyBond,
    [MOVE_PERISHSONG   - 1] = gMoveDescription_PerishSong,
    [MOVE_ICYWIND      - 1] = gMoveDescription_IcyWind,
    [MOVE_DETECT        - 1] = gMoveDescription_Detect,
    [MOVE_BONERUSH     - 1] = gMoveDescription_BoneRush,
    [MOVE_LOCKON       - 1] = gMoveDescription_LockOn,
    [MOVE_OUTRAGE       - 1] = gMoveDescription_Outrage,
    [MOVE_SANDSTORM     - 1] = gMoveDescription_Sandstorm,
    [MOVE_GIGADRAIN    - 1] = gMoveDescription_GigaDrain,
    [MOVE_ENDURE        - 1] = gMoveDescription_Endure,
    [MOVE_CHARM         - 1] = gMoveDescription_Charm,
    [MOVE_ROLLOUT       - 1] = gMoveDescription_Rollout,
    [MOVE_FALSESWIPE   - 1] = gMoveDescription_FalseSwipe,
    [MOVE_SWAGGER       - 1] = gMoveDescription_Swagger,
    [MOVE_MILKDRINK    - 1] = gMoveDescription_MilkDrink,
    [MOVE_SPARK         - 1] = gMoveDescription_Spark,
    [MOVE_FURYCUTTER   - 1] = gMoveDescription_FuryCutter,
    [MOVE_STEELWING    - 1] = gMoveDescription_SteelWing,
    [MOVE_MEANLOOK     - 1] = gMoveDescription_MeanLook,
    [MOVE_ATTRACT       - 1] = gMoveDescription_Attract,
    [MOVE_SLEEPTALK    - 1] = gMoveDescription_SleepTalk,
    [MOVE_HEALBELL     - 1] = gMoveDescription_HealBell,
    ...
    [MOVE_PAINSPLIT    - 1] = gMoveDescription_PainSplit,
    [MOVE_SACREDFIRE   - 1] = gMoveDescription_SacredFire,
    [MOVE_MAGNITUDE     - 1] = gMoveDescription_Magnitude,
    [MOVE_DYNAMICPUNCH - 1] = gMoveDescription_DynamicPunch,
    [MOVE_MEGAHORN      - 1] = gMoveDescription_Megahorn,
    [MOVE_DRAGONBREATH - 1] = gMoveDescription_DragonBreath,
    [MOVE_BATONPASS    - 1] = gMoveDescription_BatonPass,
    [MOVE_ENCORE        - 1] = gMoveDescription_Encore,
    [MOVE_PURSUIT       - 1] = gMoveDescription_Pursuit,
    [MOVE_RAPIDSPIN    - 1] = gMoveDescription_RapidSpin,
    [MOVE_SWEETSCENT   - 1] = gMoveDescription_SweetScent,
    [MOVE_IRONTAIL     - 1] = gMoveDescription_IronTail,
    [MOVE_METALCLAW    - 1] = gMoveDescription_MetalClaw,
    [MOVE_VITALTHROW   - 1] = gMoveDescription_VitalThrow,
    [MOVE_MORNINGSUN   - 1] = gMoveDescription_MorningSun,
    [MOVE_SYNTHESIS     - 1] = gMoveDescription_Synthesis,
    [MOVE_MOONLIGHT     - 1] = gMoveDescription_Moonlight,
    [MOVE_HIDDENPOWER  - 1] = gMoveDescription_HiddenPower,
    [MOVE_CROSSCHOP    - 1] = gMoveDescription_CrossChop,
    [MOVE_TWISTER       - 1] = gMoveDescription_Twister,
    [MOVE_RAINDANCE    - 1] = gMoveDescription_RainDance,
    [MOVE_SUNNYDAY     - 1] = gMoveDescription_SunnyDay,
    [MOVE_CRUNCH        - 1] = gMoveDescription_Crunch,
    [MOVE_MIRRORCOAT   - 1] = gMoveDescription_MirrorCoat,
    [MOVE_PSYCHUP      - 1] = gMoveDescription_PsychUp,
    [MOVE_EXTREMESPEED - 1] = gMoveDescription_ExtremeSpeed,
    [MOVE_ANCIENTPOWER - 1] = gMoveDescription_AncientPower,
    [MOVE_SHADOWBALL   - 1] = gMoveDescription_ShadowBall,
    [MOVE_FUTURESIGHT  - 1] = gMoveDescription_FutureSight,
    [MOVE_ROCKSMASH    - 1] = gMoveDescription_RockSmash,
    [MOVE_WHIRLPOOL     - 1] = gMoveDescription_Whirlpool,
    [MOVE_BEATUP       - 1] = gMoveDescription_BeatUp,
    [MOVE_FAKEOUT      - 1] = gMoveDescription_FakeOut,
    [MOVE_UPROAR        - 1] = gMoveDescription_Uproar,
    [MOVE_STOCKPILE     - 1] = gMoveDescription_Stockpile,
    [MOVE_SPITUP       - 1] = gMoveDescription_SpitUp,
    [MOVE_SWALLOW       - 1] = gMoveDescription_Swallow,
    [MOVE_HEATWAVE     - 1] = gMoveDescription_HeatWave,
    [MOVE_HAIL          - 1] = gMoveDescription_Hail,
    [MOVE_TORMENT       - 1] = gMoveDescription_Torment,
    [MOVE_FLATTER       - 1] = gMoveDescription_Flatter,
    [MOVE_WILLOWISP   - 1] = gMoveDescription_WillOWisp,
    [MOVE_MEMENTO       - 1] = gMoveDescription_Memento,
    [MOVE_FACADE        - 1] = gMoveDescription_Facade,
    [MOVE_FOCUSPUNCH   - 1] = gMoveDescription_FocusPunch,
    [MOVE_SMELLINGSALTS - 1] = gMoveDescription_SmellingSalt,
    [MOVE_FOLLOWME     - 1] = gMoveDescription_FollowMe,
    [MOVE_NATUREPOWER  - 1] = gMoveDescription_NaturePower,
    [MOVE_CHARGE        - 1] = gMoveDescription_Charge,
    [MOVE_TAUNT         - 1] = gMoveDescription_Taunt,
    [MOVE_HELPINGHAND  - 1] = gMoveDescription_HelpingHand,
    [MOVE_TRICK         - 1] = gMoveDescription_Trick,
    [MOVE_ROLEPLAY     - 1] = gMoveDescription_RolePlay,
    ...
    [MOVE_SECRETPOWER  - 1] = gMoveDescription_SecretPower,
    [MOVE_DIVE          - 1] = gMoveDescription_Dive,
    [MOVE_ARMTHRUST    - 1] = gMoveDescription_ArmThrust,
    [MOVE_CAMOUFLAGE    - 1] = gMoveDescription_Camouflage,
    [MOVE_TAILGLOW     - 1] = gMoveDescription_TailGlow,
    [MOVE_LUSTERPURGE  - 1] = gMoveDescription_LusterPurge,
    [MOVE_MISTBALL     - 1] = gMoveDescription_MistBall,
    [MOVE_FEATHERDANCE - 1] = gMoveDescription_FeatherDance,
    [MOVE_TEETERDANCE  - 1] = gMoveDescription_TeeterDance,
    [MOVE_BLAZEKICK    - 1] = gMoveDescription_BlazeKick,
    [MOVE_MUDSPORT     - 1] = gMoveDescription_MudSport,
    [MOVE_ICEBALL      - 1] = gMoveDescription_IceBall,
    [MOVE_NEEDLEARM    - 1] = gMoveDescription_NeedleArm,
    [MOVE_SLACKOFF     - 1] = gMoveDescription_SlackOff,
    [MOVE_HYPERVOICE   - 1] = gMoveDescription_HyperVoice,
    [MOVE_POISONFANG   - 1] = gMoveDescription_PoisonFang,
    [MOVE_CRUSHCLAW    - 1] = gMoveDescription_CrushClaw,
    [MOVE_BLASTBURN    - 1] = gMoveDescription_BlastBurn,
    [MOVE_HYDROCANNON  - 1] = gMoveDescription_HydroCannon,
    [MOVE_METEORMASH   - 1] = gMoveDescription_MeteorMash,
    [MOVE_ASTONISH      - 1] = gMoveDescription_Astonish,
    [MOVE_WEATHERBALL  - 1] = gMoveDescription_WeatherBall,
    [MOVE_AROMATHERAPY  - 1] = gMoveDescription_Aromatherapy,
    [MOVE_FAKETEARS    - 1] = gMoveDescription_FakeTears,
    [MOVE_AIRCUTTER    - 1] = gMoveDescription_AirCutter,
    [MOVE_OVERHEAT      - 1] = gMoveDescription_Overheat,
    [MOVE_ODORSLEUTH   - 1] = gMoveDescription_OdorSleuth,
    [MOVE_ROCKTOMB     - 1] = gMoveDescription_RockTomb,
    [MOVE_SILVERWIND   - 1] = gMoveDescription_SilverWind,
    [MOVE_METALSOUND   - 1] = gMoveDescription_MetalSound,
    [MOVE_GRASSWHISTLE - 1] = gMoveDescription_GrassWhistle,
    [MOVE_TICKLE        - 1] = gMoveDescription_Tickle,
    [MOVE_COSMICPOWER  - 1] = gMoveDescription_CosmicPower,
    [MOVE_WATERSPOUT   - 1] = gMoveDescription_WaterSpout,
    [MOVE_SIGNALBEAM   - 1] = gMoveDescription_SignalBeam,
    [MOVE_SHADOWPUNCH  - 1] = gMoveDescription_ShadowPunch,
    [MOVE_EXTRASENSORY  - 1] = gMoveDescription_Extrasensory,
    [MOVE_SKYUPPERCUT  - 1] = gMoveDescription_SkyUppercut,
    [MOVE_SANDTOMB     - 1] = gMoveDescription_SandTomb,
    [MOVE_SHEERCOLD    - 1] = gMoveDescription_SheerCold,
    [MOVE_MUDDYWATER   - 1] = gMoveDescription_MuddyWater,
    [MOVE_BULLETSEED   - 1] = gMoveDescription_BulletSeed,
    [MOVE_AERIALACE    - 1] = gMoveDescription_AerialAce,
    [MOVE_ICICLESPEAR  - 1] = gMoveDescription_IcicleSpear,
    [MOVE_IRONDEFENSE  - 1] = gMoveDescription_IronDefense,
    [MOVE_BLOCK         - 1] = gMoveDescription_Block,
    [MOVE_HOWL          - 1] = gMoveDescription_Howl,
    [MOVE_DRAGONCLAW   - 1] = gMoveDescription_DragonClaw,
    [MOVE_FRENZYPLANT  - 1] = gMoveDescription_FrenzyPlant,
    [MOVE_BULKUP       - 1] = gMoveDescription_BulkUp,
    [MOVE_BOUNCE        - 1] = gMoveDescription_Bounce,
    [MOVE_MUDSHOT      - 1] = gMoveDescription_MudShot,
    [MOVE_POISONTAIL   - 1] = gMoveDescription_PoisonTail,
    [MOVE_COVET         - 1] = gMoveDescription_Covet,
    [MOVE_VOLTTACKLE   - 1] = gMoveDescription_VoltTackle,
    [MOVE_MAGICALLEAF  - 1] = gMoveDescription_MagicalLeaf,
    [MOVE_WATERSPORT   - 1] = gMoveDescription_WaterSport,
    [MOVE_CALMMIND     - 1] = gMoveDescription_CalmMind,
    [MOVE_LEAFBLADE    - 1] = gMoveDescription_LeafBlade,
    [MOVE_DRAGONDANCE  - 1] = gMoveDescription_DragonDance,
    [MOVE_ROCKBLAST    - 1] = gMoveDescription_RockBlast,
    [MOVE_SHOCKWAVE    - 1] = gMoveDescription_ShockWave,
    [MOVE_WATERPULSE   - 1] = gMoveDescription_WaterPulse,
    [MOVE_DOOMDESIRE   - 1] = gMoveDescription_DoomDesire,
    [MOVE_PSYCHOBOOST  - 1] = gMoveDescription_PsychoBoost,
};
