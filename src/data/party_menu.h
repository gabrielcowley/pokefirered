...
static const u8 *const sFieldMoveDescriptionTable[] =
{
    ...
    [FIELD_MOVE_ROCKSMASH]   = gText_ShatterACrackedRock,
    ...
    [FIELD_MOVE_MILKDRINK]   = gText_ShareHp,
    [FIELD_MOVE_SOFTBOILED]  = gText_ShareHp,
    [FIELD_MOVE_SWEETSCENT]  = gText_LureWildPokemon,
};
...
} const sCursorOptions[] =
{
    ...
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_ROCKSMASH]   = {gMoveNames[MOVE_ROCKSMASH],   CursorCB_FieldMove},
    ...
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_MILKDRINK]   = {gMoveNames[MOVE_MILKDRINK],   CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SOFTBOILED]  = {gMoveNames[MOVE_SOFTBOILED],  CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SWEETSCENT]  = {gMoveNames[MOVE_SWEETSCENT],  CursorCB_FieldMove},
};
...
{
    MOVE_FLASH, MOVE_CUT, MOVE_FLY, MOVE_STRENGTH, MOVE_SURF, MOVE_ROCKSMASH, MOVE_WATERFALL, MOVE_TELEPORT,
    MOVE_DIG, MOVE_MILKDRINK, MOVE_SOFTBOILED, MOVE_SWEETSCENT, FIELD_MOVE_END // this may be misuse of enum. same in emerald
};
