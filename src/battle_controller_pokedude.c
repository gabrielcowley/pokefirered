...
{
    {
        ...
        .moves = { MOVE_TACKLE, MOVE_TAILWHIP, MOVE_HYPERFANG, MOVE_QUICKATTACK },
...
static const struct PokedudeBattlePartyInfo sParties_Status[] =
{
    ...
    },
    {
        ...
        .moves = { MOVE_ABSORB, MOVE_SWEETSCENT, MOVE_POISONPOWDER },
        .nature = NATURE_RASH,
        .gender = MALE,
    },
    {0xFF}
...
{
    {
        ...
        .moves = { MOVE_WATERGUN, MOVE_HYPNOSIS, MOVE_BUBBLE },
        .nature = NATURE_RASH,
        .gender = MALE,
    },
    {
...
{
    {
        ...
        .level = 15,
        .species = SPECIES_BUTTERFREE,
        .moves = { MOVE_CONFUSION, MOVE_POISONPOWDER, MOVE_SLEEPPOWDER, MOVE_STUNSPORE },
        .nature = NATURE_RASH,
        .gender = MALE,
    },
    {
        ...
        .moves = { MOVE_SING, MOVE_DEFENSECURL, MOVE_POUND },
